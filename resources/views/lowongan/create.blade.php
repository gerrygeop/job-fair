        ...
        <div class="p-6 text-gray-900">
            ...
            <form action="{{ route('d.lowongan.store') }}" method="POST">
                ...
                <div>
                    ...
                    <x-text-input id="judul" class="block mt-1 w-full" type="text" name="judul" :value="old('judul')" required autofocus autocomplete="judul" placeholder="Sales" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-input id="kota" class="block mt-1 w-full" type="text" name="kota" :value="old('kota')" required autocomplete="kota" placeholder="Jakarta" />
                ...
                <div class="mt-4">
                    ...
                    <x-text-area id="deskripsi" class="block mt-1 w-full" name="deskripsi" rows="5" placeholder="Tambahkan deskripsi tentang pekerjaan" required>{{ old('deskripsi') }}</x-text-area>
